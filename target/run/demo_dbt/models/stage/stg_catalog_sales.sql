  ...
  create or replace  view ANALYTICS.PUBLIC_stage.stg_catalog_sales  as (
    ...
    SELECT
        ...
        cs_net_profit 
    FROM 
        ANALYTICS.PUBLIC_customers.catalog_sales
),
...
date_ref AS (
    SELECT * FROM ANALYTICS.PUBLIC_misc.demo_dates
),

time_ref AS (
    SELECT * FROM ANALYTICS.PUBLIC_misc.demo_times
),
